...
import PopupOnClick from "../../common/PopupOnClick";
import { RemarkList } from "../../common/RemarkList";
import LegacyFretboard from "../canvas/LegacyFretboard";
...
/**
 * 元のChordSegment.tsxの見た目を完全再現
 * 326行の元コードと同一のスタイリング
 */
const LegacyChordSegment: React.FC<LegacyChordSegmentProps> = (props) => {
        ...
        >
          ...
          >
            <div style={{ width: leftWidth, display: "inline-block" }}>
              <LegacyFretboard note={getChordNote(chord)} scrollLeft={scrollLeft} onScroll={onScroll} />
            </div>
          </div>
        </div>
...
export default LegacyChordSegment;