...
try:
    ...
    sys.modules["_curses"] = curses

# cursesの問題を解決してからCLIモジュールをインポート
...
@pytest.mark.skipif(sys.platform == "win32" and not CURSES_AVAILABLE, reason="curses not available on Windows")
